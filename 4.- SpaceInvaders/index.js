...
const drawPixel = (color, x, y, bullet) => {
    ...
    if (bullet) {
        state.context.fillRect(x * SQUARE_SIZE + (SQUARE_SIZE / 2 - BULLET_WIDTH / 2), y * SQUARE_SIZE, BULLET_WIDTH, SQUARE_SIZE);
    }
    else {
...
const enemyShoot = () => __awaiter(this, void 0, void 0, function* () {
...
const onHitPlayer = () => __awaiter(this, void 0, void 0, function* () {
...
const onHitEnemy = (enemy) => __awaiter(this, void 0, void 0, function* () {
...
const detectCollision = () => __awaiter(this, void 0, void 0, function* () {
    for (let idx = 0; idx < state.bullets.length; idx++) {
        ...
        */
        if (bullet.target === PLAYER) { // px12.5 pxn250 pxnw270 bx9.5 bxn188 bxnw 192
            ...
            if (((bulletX <= playerX
                && playerX <= bulletMaxX) || (bulletX <= playerMaxX
                && bulletMaxX >= playerMaxX) || (bulletX >= playerX
                && bulletMaxX <= playerMaxX))
                &&
                    ((bulletMaxY >= playerY
                        && playerY <= bulletY) || (bulletMaxY >= playerMaxY
                        && bulletY <= playerMaxY))) {
                console.log('----------------');
            ...
            for (let i = 0; i < state.enemies.length; i++) {
                ...
                if (((bulletX <= enemyX
                    && enemyX <= bulletMaxX) || (bulletX <= enemyMaxX
                    && bulletMaxX >= enemyMaxX) || (bulletX >= enemyX
                    && bulletMaxX <= enemyMaxX))
                    &&
                        ((bulletY <= enemyMaxY
                            && enemyMaxY <= bulletY) || (bulletMaxY >= enemyMaxY
                            && bulletY <= enemyMaxY))) {
                    console.log('--------------');
...
const moveBullets = () => __awaiter(this, void 0, void 0, function* () {
    state.bullets.forEach(bullet => {
...
const removeBullet = (bullet) => __awaiter(this, void 0, void 0, function* () {
...
const findEdgestEnemy = (direction) => {
    let edgest = { position: { x: (direction === LEFT) ? Infinity : -1, y: -1 }, score: 0 };
    let highestY = -1;
    if (direction === LEFT) {
        state.enemies.forEach(enemy => {
            const { x, y } = enemy.position;
...
const checkEnemyMove = (enemy, direction) => {
    const { x, y } = enemy.position;
...
const moveEnemies = () => __awaiter(this, void 0, void 0, function* () {
